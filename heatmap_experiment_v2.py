...
PREF_MODEL    = os.path.join(_REPO_ROOT, "checkpoints", "WMForger", "convnext_pref_model.pth")
OUTPUT_DIR    = os.path.join(_REPO_ROOT, "results", "v2")
